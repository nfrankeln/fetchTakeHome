import { Menu, MenuButton, Button, MenuList, MenuItem, Flex, Center } from '@chakra-ui/react';
...
export function PagePagination({ currentPage, totalPages, onPageChange }) {
  ...
  return (
    <>
    <Flex minW={'100%'} alignItems={'center'} justifyContent={'flex-end'} pr={{base:5, lg:40}} pb={5} gap={10}>
      {currentPage > 1 && (
      ...
      <Menu>
        <MenuButton bg={'purple.500'} pl={10} pr={10}
        color={'white'} 
       as={Button}>
