...
import { Stack, Button, Container, FormControl, FormErrorMessage, FormLabel, Heading, Input,Text } from '@chakra-ui/react';
import login from '../utils/login';


export default function LoginPage(){
    const { handleSubmit, formState: { errors, isSubmitting }, register, } = useForm( {reValidateMode: 'onChange' });
  ...
  <Stack spacing={4} align="center">
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <Button width="full" mt={4} bg={'purple.500'} color={'white'} type="submit" isLoading={isSubmitting}>
        Login
      </Button>
    </form>
  </Stack>
